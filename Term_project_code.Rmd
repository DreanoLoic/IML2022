...
Scaled data is used. K nearest neighbor is tried with different values of k: 1, 5, 10, 15, 20 and 50. Accuracy on the  validation set for each of them are respectively
