...
Generalization accuracy and perplexity is calculated using cross-validation. The data is randomly divided into 10 folds and performance measures are calculated using each fold as a validation data in turn. This process is repeated 100, The performance measures are the means of the 10 validation results over the 100 repetitions. 
