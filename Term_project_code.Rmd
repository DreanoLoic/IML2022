...
Some methods include variable selection in itself, like Lasso and decision trees. We investigate Lasso combined with logistic regression, basic decision tree and random forest. The accuracy of the approaches are also calculated as well as perplexity of logistic regression with Lasso.
...
rf.npf <- randomForest(class2~., data = npf_train.rf, mtry = 5, importance = TRUE)
