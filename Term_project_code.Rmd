...
There are 20 observations predicted to be nonevent even though the event has occurred and respectively 15 observations given the false prediction of event. All together, the accuracy in validation set is 84,9 %.
