...
npf_results[nrow(npf_results)+1,] <- c("Log reg Lasso scaled", 
...
# And it works! I didn't know how to use your other loop though for mean CV perplexity!
  ...
  phat_DummyCV <- mean(as.numeric(df_DummyCV$phat))
  
  l.acc.DummyCV = c(l.acc.DummyCV,phat_DummyCV)
  # l.perp.DummyCV = c(l.perp.DummyCV,perplexity(phat_RF_CV,)
}
